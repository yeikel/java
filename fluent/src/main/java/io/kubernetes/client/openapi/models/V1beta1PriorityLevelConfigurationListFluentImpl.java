...
public class V1beta1PriorityLevelConfigurationListFluentImpl<
    ...
    implements io.kubernetes.client.openapi.models.V1beta1PriorityLevelConfigurationListFluent<A> {
  ...
  public class ItemsNestedImpl<N>
      extends io.kubernetes.client.openapi.models.V1beta1PriorityLevelConfigurationFluentImpl<
    ...
    ItemsNestedImpl(
      ...
      this.index = index;
      this.builder =
          new io.kubernetes.client.openapi.models.V1beta1PriorityLevelConfigurationBuilder(
              this, item);
    }
