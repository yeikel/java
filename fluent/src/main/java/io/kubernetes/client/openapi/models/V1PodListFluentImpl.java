...
/** Generated */
public class V1PodListFluentImpl<A extends io.kubernetes.client.openapi.models.V1PodListFluent<A>>
    extends io.kubernetes.client.fluent.BaseFluent<A>
    implements io.kubernetes.client.openapi.models.V1PodListFluent<A> {
  ...
  private java.util.ArrayList<io.kubernetes.client.openapi.models.V1PodBuilder> items;
  ...
  public A addToItems(java.lang.Integer index, io.kubernetes.client.openapi.models.V1Pod item) {
    if (this.items == null) {
      this.items = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1PodBuilder>();
    }
    io.kubernetes.client.openapi.models.V1PodBuilder builder =
        new io.kubernetes.client.openapi.models.V1PodBuilder(item);
  ...
  public A addToItems(io.kubernetes.client.openapi.models.V1Pod... items) {
    ...
    for (io.kubernetes.client.openapi.models.V1Pod item : items) {
      io.kubernetes.client.openapi.models.V1PodBuilder builder =
          new io.kubernetes.client.openapi.models.V1PodBuilder(item);
      _visitables.get("items").add(builder);
  ...
  public A addAllToItems(java.util.Collection<io.kubernetes.client.openapi.models.V1Pod> items) {
    if (this.items == null) {
      this.items = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1PodBuilder>();
    }
    for (io.kubernetes.client.openapi.models.V1Pod item : items) {
  ...
  public A removeMatchingFromItems(
    ...
    final Iterator<io.kubernetes.client.openapi.models.V1PodBuilder> each = items.iterator();
    final List visitables = _visitables.get("items");
    while (each.hasNext()) {
      io.kubernetes.client.openapi.models.V1PodBuilder builder = each.next();
   ...
   */
  @java.lang.Deprecated
  public java.util.List<io.kubernetes.client.openapi.models.V1Pod> getItems() {
  ...
  public io.kubernetes.client.openapi.models.V1Pod buildMatchingItem(
      java.util.function.Predicate<io.kubernetes.client.openapi.models.V1PodBuilder> predicate) {
    for (io.kubernetes.client.openapi.models.V1PodBuilder item : items) {
  ...
  public io.kubernetes.client.openapi.models.V1PodListFluent.ItemsNested<A> addNewItem() {
    return new io.kubernetes.client.openapi.models.V1PodListFluentImpl.ItemsNestedImpl();
  }
  ...
  public io.kubernetes.client.openapi.models.V1PodListFluent.ItemsNested<A> addNewItemLike(
    ...
    return new io.kubernetes.client.openapi.models.V1PodListFluentImpl.ItemsNestedImpl(-1, item);
  }
  ...
  public io.kubernetes.client.openapi.models.V1PodListFluent.ItemsNested<A> setNewItemLike(
    ...
    return new io.kubernetes.client.openapi.models.V1PodListFluentImpl.ItemsNestedImpl(index, item);
  }
  ...
  public io.kubernetes.client.openapi.models.V1PodListFluent.MetadataNested<A> withNewMetadata() {
    return new io.kubernetes.client.openapi.models.V1PodListFluentImpl.MetadataNestedImpl();
  }
  ...
  public io.kubernetes.client.openapi.models.V1PodListFluent.MetadataNested<A> withNewMetadataLike(
    ...
    return new io.kubernetes.client.openapi.models.V1PodListFluentImpl.MetadataNestedImpl(item);
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1PodListFluentImpl that = (V1PodListFluentImpl) o;
  ...
  public class ItemsNestedImpl<N>
      extends io.kubernetes.client.openapi.models.V1PodFluentImpl<
          io.kubernetes.client.openapi.models.V1PodListFluent.ItemsNested<N>>
      implements io.kubernetes.client.openapi.models.V1PodListFluent.ItemsNested<N>,
          io.kubernetes.client.fluent.Nested<N> {
    ItemsNestedImpl(java.lang.Integer index, io.kubernetes.client.openapi.models.V1Pod item) {
      this.index = index;
      this.builder = new io.kubernetes.client.openapi.models.V1PodBuilder(this, item);
    }

    ItemsNestedImpl() {
      this.index = -1;
      this.builder = new io.kubernetes.client.openapi.models.V1PodBuilder(this);
    }
  ...
  public class MetadataNestedImpl<N>
      extends io.kubernetes.client.openapi.models.V1ListMetaFluentImpl<
          io.kubernetes.client.openapi.models.V1PodListFluent.MetadataNested<N>>
      implements io.kubernetes.client.openapi.models.V1PodListFluent.MetadataNested<N>,
          io.kubernetes.client.fluent.Nested<N> {
    ...
    public N and() {
      return (N) V1PodListFluentImpl.this.withMetadata(builder.build());
    }
