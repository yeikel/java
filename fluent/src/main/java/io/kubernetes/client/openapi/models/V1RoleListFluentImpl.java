...
/** Generated */
public class V1RoleListFluentImpl<A extends io.kubernetes.client.openapi.models.V1RoleListFluent<A>>
    extends io.kubernetes.client.fluent.BaseFluent<A>
    implements io.kubernetes.client.openapi.models.V1RoleListFluent<A> {
  ...
  private java.util.ArrayList<io.kubernetes.client.openapi.models.V1RoleBuilder> items;
  ...
  public A addToItems(java.lang.Integer index, io.kubernetes.client.openapi.models.V1Role item) {
    if (this.items == null) {
      this.items = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1RoleBuilder>();
    }
    io.kubernetes.client.openapi.models.V1RoleBuilder builder =
        new io.kubernetes.client.openapi.models.V1RoleBuilder(item);
  ...
  public A addToItems(io.kubernetes.client.openapi.models.V1Role... items) {
    ...
    for (io.kubernetes.client.openapi.models.V1Role item : items) {
      io.kubernetes.client.openapi.models.V1RoleBuilder builder =
          new io.kubernetes.client.openapi.models.V1RoleBuilder(item);
      _visitables.get("items").add(builder);
  ...
  public A addAllToItems(java.util.Collection<io.kubernetes.client.openapi.models.V1Role> items) {
    if (this.items == null) {
      this.items = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1RoleBuilder>();
    }
    for (io.kubernetes.client.openapi.models.V1Role item : items) {
  ...
  public A removeMatchingFromItems(
    ...
    final Iterator<io.kubernetes.client.openapi.models.V1RoleBuilder> each = items.iterator();
    final List visitables = _visitables.get("items");
    while (each.hasNext()) {
      io.kubernetes.client.openapi.models.V1RoleBuilder builder = each.next();
   ...
   */
  @java.lang.Deprecated
  public java.util.List<io.kubernetes.client.openapi.models.V1Role> getItems() {
  ...
  public io.kubernetes.client.openapi.models.V1Role buildMatchingItem(
      java.util.function.Predicate<io.kubernetes.client.openapi.models.V1RoleBuilder> predicate) {
    for (io.kubernetes.client.openapi.models.V1RoleBuilder item : items) {
  ...
  public io.kubernetes.client.openapi.models.V1RoleListFluent.ItemsNested<A> addNewItem() {
    return new io.kubernetes.client.openapi.models.V1RoleListFluentImpl.ItemsNestedImpl();
  }

  public io.kubernetes.client.openapi.models.V1RoleListFluent.ItemsNested<A> addNewItemLike(
      io.kubernetes.client.openapi.models.V1Role item) {
    return new io.kubernetes.client.openapi.models.V1RoleListFluentImpl.ItemsNestedImpl(-1, item);
  }
  ...
  public io.kubernetes.client.openapi.models.V1RoleListFluent.MetadataNested<A> withNewMetadata() {
    return new io.kubernetes.client.openapi.models.V1RoleListFluentImpl.MetadataNestedImpl();
  }
  ...
  public io.kubernetes.client.openapi.models.V1RoleListFluent.MetadataNested<A> withNewMetadataLike(
    ...
    return new io.kubernetes.client.openapi.models.V1RoleListFluentImpl.MetadataNestedImpl(item);
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1RoleListFluentImpl that = (V1RoleListFluentImpl) o;
  ...
  public class ItemsNestedImpl<N>
      extends io.kubernetes.client.openapi.models.V1RoleFluentImpl<
          io.kubernetes.client.openapi.models.V1RoleListFluent.ItemsNested<N>>
      implements io.kubernetes.client.openapi.models.V1RoleListFluent.ItemsNested<N>,
          io.kubernetes.client.fluent.Nested<N> {
    ItemsNestedImpl(java.lang.Integer index, io.kubernetes.client.openapi.models.V1Role item) {
      this.index = index;
      this.builder = new io.kubernetes.client.openapi.models.V1RoleBuilder(this, item);
    }

    ItemsNestedImpl() {
      this.index = -1;
      this.builder = new io.kubernetes.client.openapi.models.V1RoleBuilder(this);
    }
  ...
  public class MetadataNestedImpl<N>
      extends io.kubernetes.client.openapi.models.V1ListMetaFluentImpl<
          io.kubernetes.client.openapi.models.V1RoleListFluent.MetadataNested<N>>
      implements io.kubernetes.client.openapi.models.V1RoleListFluent.MetadataNested<N>,
          io.kubernetes.client.fluent.Nested<N> {
    ...
    public N and() {
      return (N) V1RoleListFluentImpl.this.withMetadata(builder.build());
    }
