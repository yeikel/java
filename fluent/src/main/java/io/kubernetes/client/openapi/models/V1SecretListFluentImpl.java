...
/** Generated */
public class V1SecretListFluentImpl<
        A extends io.kubernetes.client.openapi.models.V1SecretListFluent<A>>
    extends io.kubernetes.client.fluent.BaseFluent<A>
    implements io.kubernetes.client.openapi.models.V1SecretListFluent<A> {
  ...
  private java.util.ArrayList<io.kubernetes.client.openapi.models.V1SecretBuilder> items;
  ...
  public A addToItems(java.lang.Integer index, io.kubernetes.client.openapi.models.V1Secret item) {
    if (this.items == null) {
      this.items = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1SecretBuilder>();
    }
    io.kubernetes.client.openapi.models.V1SecretBuilder builder =
        new io.kubernetes.client.openapi.models.V1SecretBuilder(item);
  ...
  public A addToItems(io.kubernetes.client.openapi.models.V1Secret... items) {
    ...
    for (io.kubernetes.client.openapi.models.V1Secret item : items) {
      io.kubernetes.client.openapi.models.V1SecretBuilder builder =
          new io.kubernetes.client.openapi.models.V1SecretBuilder(item);
      _visitables.get("items").add(builder);
  ...
  public A addAllToItems(java.util.Collection<io.kubernetes.client.openapi.models.V1Secret> items) {
    if (this.items == null) {
      this.items = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1SecretBuilder>();
    }
    for (io.kubernetes.client.openapi.models.V1Secret item : items) {
  ...
  public A removeMatchingFromItems(
    ...
    final Iterator<io.kubernetes.client.openapi.models.V1SecretBuilder> each = items.iterator();
    final List visitables = _visitables.get("items");
    while (each.hasNext()) {
      io.kubernetes.client.openapi.models.V1SecretBuilder builder = each.next();
   ...
   */
  @java.lang.Deprecated
  public java.util.List<io.kubernetes.client.openapi.models.V1Secret> getItems() {
  ...
  public io.kubernetes.client.openapi.models.V1Secret buildMatchingItem(
      java.util.function.Predicate<io.kubernetes.client.openapi.models.V1SecretBuilder> predicate) {
    for (io.kubernetes.client.openapi.models.V1SecretBuilder item : items) {
  ...
  public io.kubernetes.client.openapi.models.V1SecretListFluent.ItemsNested<A> addNewItem() {
    return new io.kubernetes.client.openapi.models.V1SecretListFluentImpl.ItemsNestedImpl();
  }
  ...
  public io.kubernetes.client.openapi.models.V1SecretListFluent.ItemsNested<A> addNewItemLike(
    ...
    return new io.kubernetes.client.openapi.models.V1SecretListFluentImpl.ItemsNestedImpl(-1, item);
  }
  ...
  public io.kubernetes.client.openapi.models.V1SecretListFluent.MetadataNested<A>
      withNewMetadata() {
    return new io.kubernetes.client.openapi.models.V1SecretListFluentImpl.MetadataNestedImpl();
  }

  public io.kubernetes.client.openapi.models.V1SecretListFluent.MetadataNested<A>
      withNewMetadataLike(io.kubernetes.client.openapi.models.V1ListMeta item) {
    return new io.kubernetes.client.openapi.models.V1SecretListFluentImpl.MetadataNestedImpl(item);
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1SecretListFluentImpl that = (V1SecretListFluentImpl) o;
  ...
  public class ItemsNestedImpl<N>
      extends io.kubernetes.client.openapi.models.V1SecretFluentImpl<
          io.kubernetes.client.openapi.models.V1SecretListFluent.ItemsNested<N>>
      implements io.kubernetes.client.openapi.models.V1SecretListFluent.ItemsNested<N>,
          io.kubernetes.client.fluent.Nested<N> {
    ItemsNestedImpl(java.lang.Integer index, io.kubernetes.client.openapi.models.V1Secret item) {
      this.index = index;
      this.builder = new io.kubernetes.client.openapi.models.V1SecretBuilder(this, item);
    }

    ItemsNestedImpl() {
      this.index = -1;
      this.builder = new io.kubernetes.client.openapi.models.V1SecretBuilder(this);
    }
  ...
  public class MetadataNestedImpl<N>
      extends io.kubernetes.client.openapi.models.V1ListMetaFluentImpl<
          io.kubernetes.client.openapi.models.V1SecretListFluent.MetadataNested<N>>
      implements io.kubernetes.client.openapi.models.V1SecretListFluent.MetadataNested<N>,
          io.kubernetes.client.fluent.Nested<N> {
    ...
    public N and() {
      return (N) V1SecretListFluentImpl.this.withMetadata(builder.build());
    }
