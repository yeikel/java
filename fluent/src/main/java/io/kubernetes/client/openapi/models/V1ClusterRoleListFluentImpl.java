...
/** Generated */
public class V1ClusterRoleListFluentImpl<
        A extends io.kubernetes.client.openapi.models.V1ClusterRoleListFluent<A>>
    extends io.kubernetes.client.fluent.BaseFluent<A>
    implements io.kubernetes.client.openapi.models.V1ClusterRoleListFluent<A> {
  public V1ClusterRoleListFluentImpl() {}

  public V1ClusterRoleListFluentImpl(
      io.kubernetes.client.openapi.models.V1ClusterRoleList instance) {
  ...
  private java.util.ArrayList<io.kubernetes.client.openapi.models.V1ClusterRoleBuilder> items;
   ...
   */
  @java.lang.Deprecated
  public java.util.List<io.kubernetes.client.openapi.models.V1ClusterRole> getItems() {
  ...
  public io.kubernetes.client.openapi.models.V1ClusterRoleListFluent.ItemsNested<A> addNewItem() {
  ...
  public class ItemsNestedImpl<N>
      extends io.kubernetes.client.openapi.models.V1ClusterRoleFluentImpl<
          io.kubernetes.client.openapi.models.V1ClusterRoleListFluent.ItemsNested<N>>
      implements io.kubernetes.client.openapi.models.V1ClusterRoleListFluent.ItemsNested<N>,
          io.kubernetes.client.fluent.Nested<N> {
    ItemsNestedImpl(
        java.lang.Integer index, io.kubernetes.client.openapi.models.V1ClusterRole item) {
      this.index = index;
      this.builder = new io.kubernetes.client.openapi.models.V1ClusterRoleBuilder(this, item);
    }
  ...
  public class MetadataNestedImpl<N>
      extends io.kubernetes.client.openapi.models.V1ListMetaFluentImpl<
          io.kubernetes.client.openapi.models.V1ClusterRoleListFluent.MetadataNested<N>>
