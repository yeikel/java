...
/** Generated */
public class V1NamespaceListFluentImpl<
        A extends io.kubernetes.client.openapi.models.V1NamespaceListFluent<A>>
    extends io.kubernetes.client.fluent.BaseFluent<A>
    implements io.kubernetes.client.openapi.models.V1NamespaceListFluent<A> {
  public V1NamespaceListFluentImpl() {}

  public V1NamespaceListFluentImpl(io.kubernetes.client.openapi.models.V1NamespaceList instance) {
  ...
  private java.util.ArrayList<io.kubernetes.client.openapi.models.V1NamespaceBuilder> items;
  ...
  public A addToItems(
    ...
    if (this.items == null) {
      this.items =
          new java.util.ArrayList<io.kubernetes.client.openapi.models.V1NamespaceBuilder>();
    }
    io.kubernetes.client.openapi.models.V1NamespaceBuilder builder =
        new io.kubernetes.client.openapi.models.V1NamespaceBuilder(item);
  ...
  public A addToItems(io.kubernetes.client.openapi.models.V1Namespace... items) {
    ...
    for (io.kubernetes.client.openapi.models.V1Namespace item : items) {
      io.kubernetes.client.openapi.models.V1NamespaceBuilder builder =
          new io.kubernetes.client.openapi.models.V1NamespaceBuilder(item);
      _visitables.get("items").add(builder);
  ...
  public A removeMatchingFromItems(
    ...
    final Iterator<io.kubernetes.client.openapi.models.V1NamespaceBuilder> each = items.iterator();
    final List visitables = _visitables.get("items");
    while (each.hasNext()) {
      io.kubernetes.client.openapi.models.V1NamespaceBuilder builder = each.next();
  ...
  public io.kubernetes.client.openapi.models.V1Namespace buildMatchingItem(
      java.util.function.Predicate<io.kubernetes.client.openapi.models.V1NamespaceBuilder>
          predicate) {
    for (io.kubernetes.client.openapi.models.V1NamespaceBuilder item : items) {
  ...
  public io.kubernetes.client.openapi.models.V1NamespaceListFluent.ItemsNested<A> addNewItem() {
    return new io.kubernetes.client.openapi.models.V1NamespaceListFluentImpl.ItemsNestedImpl();
  }
  ...
  public io.kubernetes.client.openapi.models.V1NamespaceListFluent.ItemsNested<A> setNewItemLike(
      java.lang.Integer index, io.kubernetes.client.openapi.models.V1Namespace item) {
    return new io.kubernetes.client.openapi.models.V1NamespaceListFluentImpl.ItemsNestedImpl(
        index, item);
  }

  public io.kubernetes.client.openapi.models.V1NamespaceListFluent.ItemsNested<A> editItem(
  ...
  public io.kubernetes.client.openapi.models.V1NamespaceListFluent.ItemsNested<A> editMatchingItem(
      java.util.function.Predicate<io.kubernetes.client.openapi.models.V1NamespaceBuilder>
          predicate) {
    int index = -1;
  ...
  public io.kubernetes.client.openapi.models.V1NamespaceListFluent.MetadataNested<A>
      withNewMetadata() {
    return new io.kubernetes.client.openapi.models.V1NamespaceListFluentImpl.MetadataNestedImpl();
  }
  ...
  public class ItemsNestedImpl<N>
      ...
      implements io.kubernetes.client.openapi.models.V1NamespaceListFluent.ItemsNested<N>,
          io.kubernetes.client.fluent.Nested<N> {
    ItemsNestedImpl(java.lang.Integer index, io.kubernetes.client.openapi.models.V1Namespace item) {
      this.index = index;
      this.builder = new io.kubernetes.client.openapi.models.V1NamespaceBuilder(this, item);
    }

    ItemsNestedImpl() {
      this.index = -1;
      this.builder = new io.kubernetes.client.openapi.models.V1NamespaceBuilder(this);
    }
  ...
  public class MetadataNestedImpl<N>
      ...
      implements io.kubernetes.client.openapi.models.V1NamespaceListFluent.MetadataNested<N>,
          io.kubernetes.client.fluent.Nested<N> {
