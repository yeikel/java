...
public class V1ReplicationControllerStatusFluentImpl<
  ...
  public A addToConditions(
    ...
    for (io.kubernetes.client.openapi.models.V1ReplicationControllerCondition item : items) {
      io.kubernetes.client.openapi.models.V1ReplicationControllerConditionBuilder builder =
          new io.kubernetes.client.openapi.models.V1ReplicationControllerConditionBuilder(item);
      _visitables.get("conditions").add(builder);
  ...
  public io.kubernetes.client.openapi.models.V1ReplicationControllerCondition
      buildMatchingCondition(
          java.util.function.Predicate<
                  io.kubernetes.client.openapi.models.V1ReplicationControllerConditionBuilder>
              predicate) {
    for (io.kubernetes.client.openapi.models.V1ReplicationControllerConditionBuilder item :
        conditions) {
  ...
  public A withConditions(
    ...
    if (conditions != null) {
      ...
      for (io.kubernetes.client.openapi.models.V1ReplicationControllerCondition item : conditions) {
  ...
  public class ConditionsNestedImpl<N>
    ...
    ConditionsNestedImpl() {
      this.index = -1;
      this.builder =
          new io.kubernetes.client.openapi.models.V1ReplicationControllerConditionBuilder(this);
    }
    ...
    public N and() {
      return (N)
          V1ReplicationControllerStatusFluentImpl.this.setToConditions(index, builder.build());
    }
