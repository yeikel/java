...
/** Generated */
public class V1beta1CSIStorageCapacityListFluentImpl<
        A extends io.kubernetes.client.openapi.models.V1beta1CSIStorageCapacityListFluent<A>>
    extends io.kubernetes.client.fluent.BaseFluent<A>
    implements io.kubernetes.client.openapi.models.V1beta1CSIStorageCapacityListFluent<A> {
  public V1beta1CSIStorageCapacityListFluentImpl() {}
  ...
  private java.util.ArrayList<io.kubernetes.client.openapi.models.V1beta1CSIStorageCapacityBuilder>
      items;
  ...
  public A addToItems(
    ...
    io.kubernetes.client.openapi.models.V1beta1CSIStorageCapacityBuilder builder =
        new io.kubernetes.client.openapi.models.V1beta1CSIStorageCapacityBuilder(item);
  ...
  public A addToItems(io.kubernetes.client.openapi.models.V1beta1CSIStorageCapacity... items) {
    ...
    for (io.kubernetes.client.openapi.models.V1beta1CSIStorageCapacity item : items) {
      io.kubernetes.client.openapi.models.V1beta1CSIStorageCapacityBuilder builder =
          new io.kubernetes.client.openapi.models.V1beta1CSIStorageCapacityBuilder(item);
      _visitables.get("items").add(builder);
  ...
  public A removeMatchingFromItems(
    ...
    final Iterator<io.kubernetes.client.openapi.models.V1beta1CSIStorageCapacityBuilder> each =
        items.iterator();
    final List visitables = _visitables.get("items");
    while (each.hasNext()) {
      io.kubernetes.client.openapi.models.V1beta1CSIStorageCapacityBuilder builder = each.next();
   ...
   */
  @java.lang.Deprecated
  public java.util.List<io.kubernetes.client.openapi.models.V1beta1CSIStorageCapacity> getItems() {
    return items != null ? build(items) : null;
  }

  public java.util.List<io.kubernetes.client.openapi.models.V1beta1CSIStorageCapacity>
      buildItems() {
    return items != null ? build(items) : null;
  }
  ...
  public io.kubernetes.client.openapi.models.V1beta1CSIStorageCapacity buildMatchingItem(
      java.util.function.Predicate<
              io.kubernetes.client.openapi.models.V1beta1CSIStorageCapacityBuilder>
          predicate) {
    for (io.kubernetes.client.openapi.models.V1beta1CSIStorageCapacityBuilder item : items) {
  ...
  public io.kubernetes.client.openapi.models.V1beta1CSIStorageCapacityListFluent.ItemsNested<A>
      addNewItem() {
    return new io.kubernetes.client.openapi.models.V1beta1CSIStorageCapacityListFluentImpl
        .ItemsNestedImpl();
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1beta1CSIStorageCapacityListFluentImpl that = (V1beta1CSIStorageCapacityListFluentImpl) o;
  ...
  public class ItemsNestedImpl<N>
      extends io.kubernetes.client.openapi.models.V1beta1CSIStorageCapacityFluentImpl<
          io.kubernetes.client.openapi.models.V1beta1CSIStorageCapacityListFluent.ItemsNested<N>>
      implements io.kubernetes.client.openapi.models.V1beta1CSIStorageCapacityListFluent
                  .ItemsNested<
              N>,
    ...
    ItemsNestedImpl(
      ...
      this.index = index;
      this.builder =
          new io.kubernetes.client.openapi.models.V1beta1CSIStorageCapacityBuilder(this, item);
    }

    ItemsNestedImpl() {
      this.index = -1;
      this.builder = new io.kubernetes.client.openapi.models.V1beta1CSIStorageCapacityBuilder(this);
    }
  ...
  public class MetadataNestedImpl<N>
      extends io.kubernetes.client.openapi.models.V1ListMetaFluentImpl<
          io.kubernetes.client.openapi.models.V1beta1CSIStorageCapacityListFluent.MetadataNested<N>>
      implements io.kubernetes.client.openapi.models.V1beta1CSIStorageCapacityListFluent
                  .MetadataNested<
              N>,
          io.kubernetes.client.fluent.Nested<N> {
    ...
    public N and() {
      return (N) V1beta1CSIStorageCapacityListFluentImpl.this.withMetadata(builder.build());
    }
