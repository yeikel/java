...
/** Generated */
public class V1LeaseListFluentImpl<
        A extends io.kubernetes.client.openapi.models.V1LeaseListFluent<A>>
    extends io.kubernetes.client.fluent.BaseFluent<A>
    implements io.kubernetes.client.openapi.models.V1LeaseListFluent<A> {
  ...
  private java.util.ArrayList<io.kubernetes.client.openapi.models.V1LeaseBuilder> items;
  ...
  public A addToItems(java.lang.Integer index, io.kubernetes.client.openapi.models.V1Lease item) {
    if (this.items == null) {
  ...
  public A addAllToItems(java.util.Collection<io.kubernetes.client.openapi.models.V1Lease> items) {
    if (this.items == null) {
      this.items = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1LeaseBuilder>();
    }
    for (io.kubernetes.client.openapi.models.V1Lease item : items) {
   ...
   */
  @java.lang.Deprecated
  public java.util.List<io.kubernetes.client.openapi.models.V1Lease> getItems() {
  ...
  public io.kubernetes.client.openapi.models.V1LeaseListFluent.ItemsNested<A> addNewItem() {
    return new io.kubernetes.client.openapi.models.V1LeaseListFluentImpl.ItemsNestedImpl();
  }

  public io.kubernetes.client.openapi.models.V1LeaseListFluent.ItemsNested<A> addNewItemLike(
      io.kubernetes.client.openapi.models.V1Lease item) {
    return new io.kubernetes.client.openapi.models.V1LeaseListFluentImpl.ItemsNestedImpl(-1, item);
  }
  ...
  public io.kubernetes.client.openapi.models.V1LeaseListFluent.MetadataNested<A> withNewMetadata() {
    return new io.kubernetes.client.openapi.models.V1LeaseListFluentImpl.MetadataNestedImpl();
  }
  ...
  public class ItemsNestedImpl<N>
      extends io.kubernetes.client.openapi.models.V1LeaseFluentImpl<
          io.kubernetes.client.openapi.models.V1LeaseListFluent.ItemsNested<N>>
      implements io.kubernetes.client.openapi.models.V1LeaseListFluent.ItemsNested<N>,
          io.kubernetes.client.fluent.Nested<N> {
    ItemsNestedImpl(java.lang.Integer index, io.kubernetes.client.openapi.models.V1Lease item) {
      this.index = index;
      this.builder = new io.kubernetes.client.openapi.models.V1LeaseBuilder(this, item);
    }
  ...
  public class MetadataNestedImpl<N>
      extends io.kubernetes.client.openapi.models.V1ListMetaFluentImpl<
          io.kubernetes.client.openapi.models.V1LeaseListFluent.MetadataNested<N>>
