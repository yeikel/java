...
/** Generated */
public class V1IngressListFluentImpl<
        A extends io.kubernetes.client.openapi.models.V1IngressListFluent<A>>
    extends io.kubernetes.client.fluent.BaseFluent<A>
    implements io.kubernetes.client.openapi.models.V1IngressListFluent<A> {
  public V1IngressListFluentImpl() {}

  public V1IngressListFluentImpl(io.kubernetes.client.openapi.models.V1IngressList instance) {
  ...
  private java.util.ArrayList<io.kubernetes.client.openapi.models.V1IngressBuilder> items;
  ...
  public A addToItems(java.lang.Integer index, io.kubernetes.client.openapi.models.V1Ingress item) {
    if (this.items == null) {
      this.items = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1IngressBuilder>();
    }
    io.kubernetes.client.openapi.models.V1IngressBuilder builder =
        new io.kubernetes.client.openapi.models.V1IngressBuilder(item);
  ...
  public A addToItems(io.kubernetes.client.openapi.models.V1Ingress... items) {
    ...
    for (io.kubernetes.client.openapi.models.V1Ingress item : items) {
      io.kubernetes.client.openapi.models.V1IngressBuilder builder =
          new io.kubernetes.client.openapi.models.V1IngressBuilder(item);
      _visitables.get("items").add(builder);
  ...
  public A removeMatchingFromItems(
      java.util.function.Predicate<io.kubernetes.client.openapi.models.V1IngressBuilder>
          predicate) {
    if (items == null) return (A) this;
    final Iterator<io.kubernetes.client.openapi.models.V1IngressBuilder> each = items.iterator();
    final List visitables = _visitables.get("items");
    while (each.hasNext()) {
      io.kubernetes.client.openapi.models.V1IngressBuilder builder = each.next();
  ...
  public io.kubernetes.client.openapi.models.V1Ingress buildMatchingItem(
      java.util.function.Predicate<io.kubernetes.client.openapi.models.V1IngressBuilder>
          predicate) {
    for (io.kubernetes.client.openapi.models.V1IngressBuilder item : items) {
  ...
  public io.kubernetes.client.openapi.models.V1IngressListFluent.ItemsNested<A> addNewItem() {
    return new io.kubernetes.client.openapi.models.V1IngressListFluentImpl.ItemsNestedImpl();
  }
  ...
  public io.kubernetes.client.openapi.models.V1IngressListFluent.MetadataNested<A>
      withNewMetadata() {
    return new io.kubernetes.client.openapi.models.V1IngressListFluentImpl.MetadataNestedImpl();
  }

  public io.kubernetes.client.openapi.models.V1IngressListFluent.MetadataNested<A>
      withNewMetadataLike(io.kubernetes.client.openapi.models.V1ListMeta item) {
    return new io.kubernetes.client.openapi.models.V1IngressListFluentImpl.MetadataNestedImpl(item);
  }
  ...
  public class ItemsNestedImpl<N>
      ...
      implements io.kubernetes.client.openapi.models.V1IngressListFluent.ItemsNested<N>,
          io.kubernetes.client.fluent.Nested<N> {
    ItemsNestedImpl(java.lang.Integer index, io.kubernetes.client.openapi.models.V1Ingress item) {
      this.index = index;
      this.builder = new io.kubernetes.client.openapi.models.V1IngressBuilder(this, item);
    }

    ItemsNestedImpl() {
      this.index = -1;
      this.builder = new io.kubernetes.client.openapi.models.V1IngressBuilder(this);
    }
  ...
  public class MetadataNestedImpl<N>
      ...
      implements io.kubernetes.client.openapi.models.V1IngressListFluent.MetadataNested<N>,
          io.kubernetes.client.fluent.Nested<N> {
