...
/** Generated */
public class V1beta2FlowSchemaListFluentImpl<
        A extends io.kubernetes.client.openapi.models.V1beta2FlowSchemaListFluent<A>>
    extends io.kubernetes.client.fluent.BaseFluent<A>
    implements io.kubernetes.client.openapi.models.V1beta2FlowSchemaListFluent<A> {
  ...
  private java.util.ArrayList<io.kubernetes.client.openapi.models.V1beta2FlowSchemaBuilder> items;
  ...
  public class ItemsNestedImpl<N>
    ...
    ItemsNestedImpl(
        java.lang.Integer index, io.kubernetes.client.openapi.models.V1beta2FlowSchema item) {
      this.index = index;
      this.builder = new io.kubernetes.client.openapi.models.V1beta2FlowSchemaBuilder(this, item);
    }
