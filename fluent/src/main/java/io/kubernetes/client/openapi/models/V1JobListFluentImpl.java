...
public class V1JobListFluentImpl<A extends io.kubernetes.client.openapi.models.V1JobListFluent<A>>
  ...
  public A addToItems(java.lang.Integer index, io.kubernetes.client.openapi.models.V1Job item) {
    ...
    io.kubernetes.client.openapi.models.V1JobBuilder builder =
        new io.kubernetes.client.openapi.models.V1JobBuilder(item);
  ...
  public A setToItems(java.lang.Integer index, io.kubernetes.client.openapi.models.V1Job item) {
    if (this.items == null) {
      this.items = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1JobBuilder>();
    }
    io.kubernetes.client.openapi.models.V1JobBuilder builder =
  ...
  public A addToItems(io.kubernetes.client.openapi.models.V1Job... items) {
    ...
    for (io.kubernetes.client.openapi.models.V1Job item : items) {
      io.kubernetes.client.openapi.models.V1JobBuilder builder =
          new io.kubernetes.client.openapi.models.V1JobBuilder(item);
      _visitables.get("items").add(builder);
  ...
  public A removeAllFromItems(
      java.util.Collection<io.kubernetes.client.openapi.models.V1Job> items) {
    for (io.kubernetes.client.openapi.models.V1Job item : items) {
      io.kubernetes.client.openapi.models.V1JobBuilder builder =
          new io.kubernetes.client.openapi.models.V1JobBuilder(item);
      _visitables.get("items").remove(builder);
  ...
  public A removeMatchingFromItems(
    ...
    while (each.hasNext()) {
      io.kubernetes.client.openapi.models.V1JobBuilder builder = each.next();
  ...
  public io.kubernetes.client.openapi.models.V1Job buildItem(java.lang.Integer index) {
  ...
  public io.kubernetes.client.openapi.models.V1Job buildMatchingItem(
      java.util.function.Predicate<io.kubernetes.client.openapi.models.V1JobBuilder> predicate) {
    for (io.kubernetes.client.openapi.models.V1JobBuilder item : items) {
  ...
  public io.kubernetes.client.openapi.models.V1JobListFluent.ItemsNested<A> setNewItemLike(
      java.lang.Integer index, io.kubernetes.client.openapi.models.V1Job item) {
    return new io.kubernetes.client.openapi.models.V1JobListFluentImpl.ItemsNestedImpl(index, item);
  }

  public io.kubernetes.client.openapi.models.V1JobListFluent.ItemsNested<A> editItem(
  ...
  public io.kubernetes.client.openapi.models.V1JobListFluent.ItemsNested<A> editMatchingItem(
      java.util.function.Predicate<io.kubernetes.client.openapi.models.V1JobBuilder> predicate) {
    int index = -1;
  ...
  public io.kubernetes.client.openapi.models.V1JobListFluent.MetadataNested<A> withNewMetadataLike(
    ...
    return new io.kubernetes.client.openapi.models.V1JobListFluentImpl.MetadataNestedImpl(item);
  }
  ...
  public io.kubernetes.client.openapi.models.V1JobListFluent.MetadataNested<A>
  ...
  public class ItemsNestedImpl<N>
    ...
    ItemsNestedImpl() {
      this.index = -1;
      this.builder = new io.kubernetes.client.openapi.models.V1JobBuilder(this);
    }
  ...
  public class MetadataNestedImpl<N>
    ...
    public N and() {
      return (N) V1JobListFluentImpl.this.withMetadata(builder.build());
    }
