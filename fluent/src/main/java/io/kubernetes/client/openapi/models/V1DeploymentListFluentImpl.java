...
/** Generated */
public class V1DeploymentListFluentImpl<
        A extends io.kubernetes.client.openapi.models.V1DeploymentListFluent<A>>
    extends io.kubernetes.client.fluent.BaseFluent<A>
    implements io.kubernetes.client.openapi.models.V1DeploymentListFluent<A> {
  ...
  public A addToItems(
      java.lang.Integer index, io.kubernetes.client.openapi.models.V1Deployment item) {
    if (this.items == null) {
      this.items =
          new java.util.ArrayList<io.kubernetes.client.openapi.models.V1DeploymentBuilder>();
    }
    io.kubernetes.client.openapi.models.V1DeploymentBuilder builder =
        new io.kubernetes.client.openapi.models.V1DeploymentBuilder(item);
  ...
  public A addToItems(io.kubernetes.client.openapi.models.V1Deployment... items) {
    ...
    for (io.kubernetes.client.openapi.models.V1Deployment item : items) {
      io.kubernetes.client.openapi.models.V1DeploymentBuilder builder =
          new io.kubernetes.client.openapi.models.V1DeploymentBuilder(item);
      _visitables.get("items").add(builder);
  ...
  public A addAllToItems(
      java.util.Collection<io.kubernetes.client.openapi.models.V1Deployment> items) {
    if (this.items == null) {
      this.items =
          new java.util.ArrayList<io.kubernetes.client.openapi.models.V1DeploymentBuilder>();
    }
  ...
  public A removeMatchingFromItems(
      java.util.function.Predicate<io.kubernetes.client.openapi.models.V1DeploymentBuilder>
          predicate) {
  ...
  public io.kubernetes.client.openapi.models.V1Deployment buildMatchingItem(
      java.util.function.Predicate<io.kubernetes.client.openapi.models.V1DeploymentBuilder>
          predicate) {
    for (io.kubernetes.client.openapi.models.V1DeploymentBuilder item : items) {
  ...
  public io.kubernetes.client.openapi.models.V1DeploymentListFluent.ItemsNested<A> addNewItemLike(
      io.kubernetes.client.openapi.models.V1Deployment item) {
    return new io.kubernetes.client.openapi.models.V1DeploymentListFluentImpl.ItemsNestedImpl(
        -1, item);
  }

  public io.kubernetes.client.openapi.models.V1DeploymentListFluent.ItemsNested<A> setNewItemLike(
      java.lang.Integer index, io.kubernetes.client.openapi.models.V1Deployment item) {
    return new io.kubernetes.client.openapi.models.V1DeploymentListFluentImpl.ItemsNestedImpl(
        index, item);
  }

  public io.kubernetes.client.openapi.models.V1DeploymentListFluent.ItemsNested<A> editItem(
  ...
  public io.kubernetes.client.openapi.models.V1DeploymentListFluent.ItemsNested<A> editMatchingItem(
      java.util.function.Predicate<io.kubernetes.client.openapi.models.V1DeploymentBuilder>
          predicate) {
    int index = -1;
  ...
  public io.kubernetes.client.openapi.models.V1DeploymentListFluent.MetadataNested<A>
      withNewMetadata() {
  ...
  public class ItemsNestedImpl<N>
      extends io.kubernetes.client.openapi.models.V1DeploymentFluentImpl<
          io.kubernetes.client.openapi.models.V1DeploymentListFluent.ItemsNested<N>>
      implements io.kubernetes.client.openapi.models.V1DeploymentListFluent.ItemsNested<N>,
  ...
  public class MetadataNestedImpl<N>
      extends io.kubernetes.client.openapi.models.V1ListMetaFluentImpl<
          io.kubernetes.client.openapi.models.V1DeploymentListFluent.MetadataNested<N>>
      implements io.kubernetes.client.openapi.models.V1DeploymentListFluent.MetadataNested<N>,
          io.kubernetes.client.fluent.Nested<N> {
